function coi = showCoiForVideo(whichVideoNumber, modifyMode, coiMode, writeOutMovie, width, height)
...
coi = coiForVideo(whichVideoNumber, 0, coiMode,boundaries);
...
movieFileName = fullfile('/Users/John/Documents/ClipsForNorming/',[name ext]);
